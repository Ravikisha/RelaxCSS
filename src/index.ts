...
const plugin: PluginCreator<Partial<RelaxConfig>> = (opts) => {
    ...
    Once(root: Root) {
      ...
      atApplyQueue.forEach(({ rule: parentRule, classes: appliedClasses }) => {
        appliedClasses.forEach((cls) => {
          ...
          let mediaQueryVariant: string | undefined; // e.g., 'sm', 'md'
          let pseudoClassVariants: string[] = []; // e.g., 'hover', 'focus'
